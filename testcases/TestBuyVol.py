...
class TestBuyContract(unittest.TestCase):
    ...
    def test_buy_call_contract(self):
        proposal = tu.proposal_call_put(symbol=self.symbol,
                                        ...
                                        duration_unit="m")
        expected_longcode = 'Win payout if Volatility 100 Index is strictly higher than entry spot at 3 minutes after ' \
                            'contract start time.'
    ...
    def test_buy_put_contract(self):
        proposal = tu.proposal_call_put(symbol=self.symbol,
                                        ...
                                        duration=self.duration,
                                        duration_unit="m")
        expected_longcode = 'Win payout if Volatility 100 Index is strictly lower than entry spot at 3 minutes after ' \
                            'contract start time.'
